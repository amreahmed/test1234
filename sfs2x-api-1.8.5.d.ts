 ...
 */
declare class SmartFox extends EventDispatcher {
...
declare class SFSObject {
     ...
     * @returns The list of all the keys in this object.
     */
    getKeysArray(): string[];
    /**
     ...
     * @returns <code>true</code> if this object contains a mapping for the passed key.
     */
     ...
     * @param [typeId = null] - The identifier of the expected value's type; must be one of the constants set in the <em>SFSDataType</em> class.
     ...
     * @returns The value assigned to the specified key. <code>null</code> is returned if no value is associated with the passed key.
     */
    get(key: string, typeId?: number): any;
    /**
     * Indicates if the value mapped by the passed key is of type <em>SFSDataType.NULL</em>.
     * @param key - The key to be checked.
     * @returns <code>true</code> if the value mapped by the passed key is of type <em>SFSDataType.NULL</em>.
     */
     ...
     * @returns The array assigned to the specified key.
     */
    getBoolArray(key: string): any[];
    /**
     * Returns the byte array corresponding to the passed key.
     * @param key - The key whose associated byte array is to be returned.
     * @returns The byte array assigned to the specified key.
     */
     ...
     * @param key - The key whose associated array is to be returned.
     * @returns The <em>SFSObject</em> assigned to the specified key.
     */
    getSFSObject(key: string): SFSObject;
    /**
     * Returns the SFSArray corresponding to the passed key.
     * @param key - The key whose associated array is to be returned.
     * @returns The <em>SFSArray</em> assigned to the specified key.
     */
     ...
     * @param typeId - The value's type identifier; must be one of the constants set in the <em>SFSDataType</em> class.
     */
     ...
     *
     * <p>This is a shortcut for the <em>put()</em> method.</p>
     * @param key - The key to which the specified array has to be assigned.
     * @param array - The array to be assigned to the passed key.
     */
     ...
     *
     * <p>This is a shortcut for the <em>put()</em> method.</p>
     * @param key - The key to which the specified byte array has to be assigned.
     * @param array - The byte array to be assigned to the passed key.
     */
     ...
     * <p>This is a shortcut for the <em>put()</em> method.</p>
     * @param key - The key to which the specified value has to be assigned.
     * @param value - The <em>SFSArray</em> to be assigned to the passed key.
     */
     ...
     * <p>This is a shortcut for the <em>put()</em> method.</p>
     * @param key - The key to which the specified value has to be assigned.
     * @param value - The <em>SFSObject</em> to be assigned to the passed key.
     */
     ...
     * @param [format = true] - If <code>true</code>, the output is formatted in a human-readable way.
...
declare class SFSArray {
     ...
     * @returns <code>true</code> if the specified object is present in the SFSArray.
     */
     ...
     * @returns <code>true</code> if the element at the specified index is of type <em>SFSDataType.NULL</em>.
     */
     ...
     * @param index - The position of the array to return.
     * @returns The <em>SFSObject</em> at the specified index.
     */
    getSFSObject(index: number): SFSObject;
    /**
     * Returns the SFSArray at the specified index.
     * @param index - The position of the array to return.
     * @returns The <em>SFSArray</em> at the specified index.
     */
     ...
     *
     * <p>This is a shortcut for the <em>add()</em> method.</p>
     * @param array - The array to be appended to this array.
     */
     ...
     *
     * <p>This is a shortcut for the <em>add()</em> method.</p>
     * @param array - The byte array to be appended to this array.
     */
     ...
     *
     * <p>This is a shortcut for the <em>add()</em> method.</p>
     * @param value - The <em>SFSArray</em> to be appended to this array.
     */
     ...
     *
     * <p>This is a shortcut for the <em>add()</em> method.</p>
     * @param value - The <em>SFSObject</em> to be appended to this array.
     */
 ...
 * @param [pz = 0] - The position along the Z axis.
 * @param [useFloats = false] - Force the coordinates to be sent as floating point values to the server.
 */
declare class Vec3D {
 ...
 */
declare class BoolMatch extends Matcher {
    /**
 ...
 */
declare class NumberMatch extends Matcher {
    /**
 ...
 */
declare class StringMatch extends Matcher {
    /**
 ...
 * @param condition - A matching condition among those provided by the <em>BoolMatch</em>, <em>NumberMatch</em> and <em>StringMatch</em> classes.
...
declare class MatchExpression {
     ...
     * @param condition - The additional matching condition among those provided by the <em>BoolMatch</em>, <em>NumberMatch</em> and <em>StringMatch</em> classes.
     * @param value - The value to compare against the additional variable or property during the matching.
     * @returns A new <em>MatchExpression</em> resulting from the concatenation of the current expression with a new one generated from the specified parameters.
     */
     ...
     * @returns <code>true</code> if the current matching expression is concatenated to another one.
     */
    hasNext(): boolean;
    /**
     * Moves the iterator cursor to the first matching expression in the chain.
     * @returns The <em>MatchExpression</em> object at the top of the chain of matching expressions.
     */
    rewind(): MatchExpression;
    /**
     * Returns a string representation of the matching expression.
     * @returns The string representation of the <em>MatchExpression</em> object.
     */
    toString(): string;
}
...
declare class SFSBuddy {
     ...
     * @returns The string representation of the <em>SFSBuddy</em> object.
     */
    toString(): string;
    /**
     * Retrieves a Buddy Variable from its name.
     * @param varName - The name of the Buddy Variable to be retrieved.
     * @returns The object representing the Buddy Variable, or <code>undefined</code> if no Buddy Variable with the passed name is associated to this buddy.
     */
     ...
     * @returns <code>true</code> if a Buddy Variable with the passed name is set for this buddy.
     */
    containsVariable(varName: string): boolean;
    /**
     * Retrieves all the Buddy Variables of this user.
     * @returns The list of <em>SFSBuddyVariable</em> objects associated to the buddy.
     */
    getVariables(): SFSBuddyVariable[];
    /**
     * Retrieves the list of persistent Buddy Variables for this buddy.
     * @returns A list of <em>SFSBuddyVariable</em> objects corresponding to the buddy's persistent Buddy Variables.
     */
    getOfflineVariables(): SFSBuddyVariable[];
    /**
     * Retrieves the list of non-persistent Buddy Variables for this buddy.
     * @returns A list of <em>SFSBuddyVariable</em> objects corresponding to the buddy's non-persistent Buddy Variables.
     */
...
declare class MMOItem {
     ...
     * @returns The string representation of the <em>MMOItem</em> object.
     */
    toString(): string;
    /**
     * Retrieves an MMOItem Variable from its name.
     * @param varName - The name of the MMOItem Variable to be retrieved.
     * @returns The <em>MMOItemVariable</em> object, or <code>undefined</code> if no MMOItem Variable with the passed name is associated to this item.
     */
     ...
     * @returns <code>true</code> if an MMOItem Variable with the passed name is set for this item.
     */
    containsVariable(varName: string): boolean;
    /**
     * Retrieves all the MMOItem Variables of this item.
     * @returns The list of <em>MMOItemVariable</em> objects associated to this item.
     */
...
declare class SFSRoom {
     ...
     * @returns The string representation of the <em>SFSRoom</em> object.
     */
    toString(): string;
    /**
     * Retrieves a <em>SFSUser</em> object from its <em>name</em> property.
     * @param name - The name of the user to be found.
     * @returns An object representing the user, or <code>undefined</code> if no user with the passed name exists in this Room.
     */
    getUserByName(name: string): SFSUser;
    /**
     * Retrieves a <em>SFSUser</em> object from its <em>id</em> property.
     * @param id - The id of the user to be found.
     * @returns An object representing the user, or <code>undefined</code> if no user with the passed id exists in this Room.
     */
    getUserById(id: number): SFSUser;
    /**
     * Indicates whether the specified user is currently inside this Room or not.
     * @param user - The <em>SFSUser</em> object representing the user whose presence in this Room must be checked.
     * @returns <code>true</code> if the user is inside this Room; <code>false</code> otherwise.
     */
     ...
     * @returns The list of <em>SFSUser</em> objects representing the users who joined the Room.
     */
    getUserList(): SFSUser[];
    /**
     * Retrieves the list of <em>SFSUser</em> objects representing the players currently inside this Room (Game Rooms only).
     * @returns The list of <em>SFSUser</em> objects representing the users who joined the Room as players.
     */
     ...
     * @returns The list of <em>SFSUser</em> objects representing the users who joined the Room as spectators.
     */
     ...
     * @returns The object representing the Room Variable, or <code>undefined</code> if no Room Variable with the passed name exists in this Room.
     */
     ...
     * @returns <code>true</code> if a Room Variable with the passed name exists in this Room.
     */
    containsVariable(varName: string): boolean;
    /**
     * Retrieves all the Room Variables of this Room.
     * @returns The list of <em>SFSRoomVariable</em> objects associated with this Room.
     */
...
declare class MMORoom {
     ...
     * @returns An <em>MMOItem</em> object, or <code>undefined</code> if the item with the passed id is not in proximity of the current user.
     */
     ...
     * @returns A list of <em>MMOItem</em> objects, or an empty list if no item is in proximity of the current user.
     */
    getMMOItems(): MMOItem[];
}
...
declare class SFSUser {
     ...
     * @returns The string representation of the <em>SFSUser</em> object.
     */
    toString(): string;
    /**
     * Indicates whether this user joined the passed Room or not.
     * @param room - The <em>SFSRoom</em> object representing the Room where to check the user presence.
     * @returns <code>true</code> if this user is inside the passed Room.
     */
     ...
     * @param room - The <em>SFSRoom</em> object representing the Room to retrieve the player id from.
     * @returns The <em>playerId</em> of this user in the passed Room.
     */
     ...
     * @param room - The <em>SFSRoom</em> object representing the Room where to check if this user is a player.
     * @returns <code>true</code> if this user is a player in the passed Room.
     */
     ...
     * @param room - The <em>SFSRoom</em> object representing the Room where to check if this user is a spectator.
     * @returns <code>true</code> if this user is a spectator in the passed Room.
     */
     ...
     * @returns The object representing the User Variable, or <code>undefined</code> if no User Variable with the passed name is associated with this user.
     */
     ...
     * @returns <code>true</code> if a User Variable with the passed name is set for this user.
     */
    containsVariable(varName: string): boolean;
    /**
     * Retrieves all the User Variables of this user.
     * @returns The list of <em>SFSUserVariable</em> objects associated with the user.
     */
 ...
 */
declare class ReservedBuddyVariables {
    constructor();
    /**
 ...
 * @param value - The value of the Buddy Variable; it can also be <code>null</code>.
 * @param [type = -1] - The type id of the Buddy Variable among those available in the <em>VariableType</em> class. Usually it is not necessary to pass this parameter, as the type is auto-detected from the value.
 */
declare class SFSBuddyVariable extends BaseVariable {
     ...
     * @returns The string representation of the <em>SFSBuddyVariable</em> object.
     */
    toString(): string;
    /**
 ...
 * @param name - The name of the MMOItem Variable.
 * @param value - The value of the MMOItem Variable; it can also be <code>null</code>.
 * @param [type = -1] - The type id of the MMOItem Variable among those available in the <em>VariableType</em> class. Usually it is not necessary to pass this parameter, as the type is auto-detected from the value.
 */
declare class MMOItemVariable extends BaseVariable {
    constructor(name: string, value: boolean | number | string | SFSObject | SFSArray, type?: number);
    /**
     * Returns a string that contains the MMOItem Variable name, type and value.
     * @returns The string representation of the <em>MMOItemVariable</em> object.
     */
    toString(): string;
    /**
     * Indicates the name of this variable.
 ...
 */
declare class ReservedRoomVariables {
    constructor();
    /**
 ...
 * @param value - The value of the Room Variable; it can also be <code>null</code>.
 * @param [type = -1] - The type id of the Room Variable among those available in the <em>VariableType</em> class. Usually it is not necessary to pass this parameter, as the type is auto-detected from the value.
 */
declare class SFSRoomVariable extends BaseVariable {
    constructor(name: string, value: boolean | number | string | SFSObject | SFSArray, type?: number);
    /**
     ...
     * @returns The string representation of the <em>SFSRoomVariable</em> object.
     */
    toString(): string;
    /**
     * Indicates the name of this variable.
 ...
 * @param value - The value of the User Variable; it can also be <code>null</code>.
 * @param [type = -1] - The type id of the User Variable among those available in the <em>VariableType</em> class. Usually it is not necessary to pass this parameter, as the type is auto-detected from the value.
 */
declare class SFSUserVariable extends BaseVariable {
    constructor(name: string, value: boolean | number | string | SFSObject | SFSArray, type?: number);
    /**
     ...
     * @returns The string representation of the <em>SFSUserVariable</em> object.
     */
    toString(): string;
    /**
     * Indicates the name of this variable.
...
declare class SFSBuddyManager {
     ...
     * @returns <code>true</code> if the specified buddy exists in the buddy list.
     */
     ...
     * @returns The <em>SFSBuddy</em> object representing the buddy, or <code>undefined</code> if no buddy with the passed id exists in the buddy list.
     */
     ...
     * @returns The <em>SFSBuddy</em> object representing the buddy, or <code>undefined</code> if no buddy with the passed name exists in the buddy list.
     */
     ...
     * @returns The <em>SFSBuddy</em> object representing the buddy, or <code>undefined</code> if no buddy with the passed nickname exists in the buddies list.
     */
     ...
     * @returns A list of <em>SFSBuddy</em> objects representing the offline buddies.
     */
     ...
     * @returns A list of <em>SFSBuddy</em> objects representing the online buddies.
     */
    getOnlineBuddies(): SFSBuddy[];
    /**
     * Returns a list of <em>SFSBuddy</em> objects representing all the buddies in the user's buddy list.
     * @returns A list of <em>SFSBuddy</em> objects representing all the buddies.
     */
    getBuddyList(): SFSBuddy[];
    /**
     * Retrieves a Buddy Variable set for the current user from its name.
     * @param varName - The name of the Buddy Variable to be retrieved.
     * @returns The <em>SFSBuddyVariable</em> object representing the Buddy Variable, or <code>undefined</code> if no Buddy Variable with the passed name is associated to the current user.
     */
    getMyVariable(varName: string): SFSBuddyVariable;
    /**
     * Returns all the Buddy Variables set for the current user.
     * @returns A list of <em>SFSBuddyVariable</em> objects representing all the Buddy Variables set for the user.
     */
     ...
     * @returns <code>true</code> if the user is online in the Buddy List system.
     */
...
declare class SFSRoomManager {
     ...
     * @param groupId - The name of the Group.
     * @returns <code>true</code> if the client subscribed the passed Group.
     */
    containsGroup(groupId: string): boolean;
    /**
     * Indicates whether a Room exists in the Rooms list or not.
     * @param idOrName - The id or name of the <em>SFSRoom</em> object whose presence in the Rooms list is to be tested.
     * @returns <code>true</code> if the passed Room exists in the Rooms list.
     */
     ...
     * @returns <code>true</code> if the Rooms list contains the passed Room and it belongs to the specified Group.
     */
     ...
     *
     * <p><b>NOTE</b>: at login time, the client automatically subscribes all the Room Groups specified in the Zone's <b>Default Room Groups</b> setting.</p>
     * @returns The list of the available <em>SFSRoom</em> objects.
     */
    getRoomList(): SFSRoom[];
    /**
     ...
     * @returns The list of <em>SFSRoom</em> objects representing the Rooms currently joined by the client.
     */
    getJoinedRooms(): SFSRoom[];
    /**
     ...
     * @param user - A <em>SFSUser</em> object representing the user to look for in the current Rooms list.
...
declare class SFSUserManager {
     ...
     * @returns <code>true</code> if the passed user exists in the users list.
     */
     ...
     * @param user - The <em>SFSUser</em> object representing the user whose presence in the users list is to be tested.
     * @returns <code>true</code> if the passed user exists in the users list.
     */
    containsUser(user: SFSUser): boolean;
    /**
     ...
     * @returns The <em>SFSUser</em> object representing the user, or <code>undefined</code> if no user with the passed id exists in the local users list.
     */
    getUserById(userId: number): SFSUser;
    /**
     * Retrieves a <em>SFSUser</em> object from its <em>name</em> property.
     * @param userName - The name of the user to be retrieved.
     * @returns The <em>SFSUser</em> object representing the user, or <code>undefined</code> if no user with the passed name exists in the local users list.
     */
     ...
     * @returns The list of <em>SFSUser</em> objects representing the users in the local users list.
     */
    getUserList(): SFSUser[];
}
 ...
 * @param defaultAOI - The Area of Interest (AoI) for the MMORoom to be created.
 */
declare class MMORoomSettings {
 ...
 * @param name - The name of the Game Room to be created.
 */
declare class ClusterRoomSettings {
    constructor(name: string);
    /**
     * Indicates whether the game is public or private.
     *
 ...
 */
declare class MessageRecipientMode {
 ...
 * @param nodeId - The identifier of the Game Node where the Room is located.
 * @param roomId - The identifier of the Room on the Game Node.
 */
declare class ClusterTarget {
 ...
 */
declare class BlockBuddyRequest {
 ...
 * @param targetBuddy - The <em>SFSBuddy</em> object corresponding to the message recipient.
 * @param [params = null] - A <em>SFSObject</em> containing additional custom parameters (e.g. the message color, an emoticon id, etc).
 */
 ...
 * }
 */
declare class InitBuddyListRequest {
}
 ...
 * @param buddyName - The name of the buddy to be removed from the user's buddy list.
 */
declare class RemoveBuddyRequest {
    constructor(buddyName: string);
}
 ...
 * 	}
 * }
 * @param buddyVariables - A list of <em>SFSBuddyVariable</em> objects representing the Buddy Variables to set.
 */
declare class SetBuddyVariablesRequest {
 ...
 * @example
 * <caption>This example sends an invitation to join the current user in their current Game Room.</caption>
 * function someMethod()
 * {
 ...
 * }
 * @param target - A <em>ClusterTarget</em> object containing the identifiers of the Game Node and Room the users are invited to join.
 * @param invitedUsers - A list of <em>SFSUser</em> objects, each representing a user to send the invitation to.
 ...
 * @param [params = null] - An <em>SFSObject</em> containing custom parameters containing additional invitation details.
 */
declare class ClusterInviteUsersRequest {
 ...
 * In case the client is already connected to the target Game Node, the <em>roomJoin</em> event is received immediately.</p>
 * @example
 * <caption>The following example makes the user quickly join a public game.</caption>
 * function someMethod()
 * {
 * 	sfsLobby.addEventListener(SFS2X.SFSClusterEvent.CONNECTION_REQUIRED, onGameNodeConnectionRequired, this);
 *
 ...
 * }
 * @param matchExpression - A matching expression that the system will use to search a Game Room where to join the current user; if <code>null</code>, a new Game Room will be created.
 * @param groupList - A list of group names to further filter the search; if <code>null</code>, all groups will be searched.
 ...
 */
declare class ClusterJoinOrCreateRequest {
 ...
 */
declare class CreateSFSGameRequest {
 ...
 * 	console.log("Failed to reply to invitation due to the following problem: " + evtParams.errorMessage);
 * }
 * @param invitation - An instance of the <em>SFSInvitation</em> class containing the invitation details (inviter, custom parameters, etc).
 ...
 * @param [params = null] - A <em>SFSObject</em> containing custom parameters to be returned to the inviter together with the reply (for example a message describing the reason of refusal).
 */
declare class InvitationReplyRequest {
 ...
 * @param [params = null] - An <em>SFSObject</em> containing custom parameters containing additional invitation details.
 */
declare class InviteUsersRequest {
 ...
 * @param [params = null] - A <em>SFSOobject</em> containing any relevant parameter or message to be sent to the invited users (for example an invitation message).
 * @param [expirySeconds = 30] - The time given to the invitee to reply to the invitation.
 * @param [asSpectator = false] - In Game Rooms only, indicates if the invited user(s) should join as spectator(s) instead of player(s).
 */
declare class JoinRoomInvitationRequest {
 ...
 * @example
 * <caption>This example makes the current user join a Darts game with a "maximum bet" condition.</caption>
 * function someMethod()
 * {
 * 	sfs.addEventListener(SFS2X.SFSEvent.ROOM_JOIN, onRoomJoin, this);
 *
 ...
 * 	console.log("Successfully joined Room: " + evtParams.room);
 * }
 * @param matchExpression - A matching expression that the system will use to search a Game Room where to join the current user. If <code>null</code> is passed, the first available game Room is joined.
 * @param whereToSearch - An array of <em>SFSRoom</em> objects or an array of Group names to which the matching expression should be applied. The maximum number of elements that this array can contain is 32.
 * @param [roomToLeave = null] - A <em>SFSRoom</em> object representing the Room that the user should leave when joining the game.
 */
declare class QuickJoinGameRequest {
 ...
 * @param [targetRoom = null] - The <em>MMORoom</em> object corresponding to the Room where the position should be set; if <code>null</code>, the last Room joined by the user is used.
 */
declare class SetUserPositionRequest {
 ...
 * @param [message = null] - A custom message to be delivered to the user before banning him; if <code>null</code>, the default message configured in the SmartFoxServer 2X Administration Tool is used.
 * @param [banMode = BanMode.BY_NAME] - One of the ban modes defined in the <em>BanMode</em> class.
 ...
 */
declare class ChangeRoomCapacityRequest {
 ...
 * 	console.log("Room name change failed: " + evtParams.errorMessage);
 * }
 * @param room - The <em>SFSRoom</em> object corresponding to the Room whose name should be changed.
 * @param newName - The new name to be assigned to the Room.
 */
declare class ChangeRoomNameRequest {
 ...
 * }
 * @param room - The <em>SFSRoom</em> object corresponding to the Room whose password should be changed.
 ...
 */
declare class ChangeRoomPasswordStateRequest {
 ...
 * @param [autoJoin = false] - If <code>true</code>, the Room is joined as soon as it is created.
 * @param [roomToLeave = null] - A <em>SFSRoom</em> object representing the Room that should be left if the new Room is auto-joined.
 */
declare class CreateRoomRequest {
 ...
 * @param [params = null] - An <em>SFSObject</em> containing custom data to be sent to the Extension. Can be null if no data needs to be sent.
 * @param [room = null] - If <code>null</code>, the specified command is sent to the current Zone server-side Extension; if not <code>null</code>, the command is sent to the server-side Extension attached to the passed Room.
 */
declare class ExtensionRequest {
 ...
 * @param [groupId = null] - The name of the Group where to search for matching Rooms; if <code>null</code>, the search is executed in the whole Zone.
 * @param [limit = 0] - The maximum size of the list of Rooms that will be returned by the <em>roomFindResult</em> event. If <code>0</code>, all the found Rooms are returned.
 */
declare class FindRoomsRequest {
 ...
 * @param [target = null] - The name of a Group or a single <em>SFSRoom</em> object where to search for matching users; if <code>null</code>, the search is executed in the whole Zone.
 * @param [limit = 0] - The maximum size of the list of users that will be returned by the <em>userFindResult</em> event. If <code>0</code>, all the found users are returned.
 */
declare class FindUsersRequest {
 ...
 * 	console.log("Room joining failed: " + evtParams.errorMessage);
 * }
 * @param room - The id or the name of the Room to be joined. A <em>SFSRoom</em> object can be passed too.
 * @param [password = null] - The password of the Room, in case it is password protected.
 * @param [roomIdToLeave = null] - The id of a previously joined Room that the user should leave when joining the new Room. By default, the last joined Room is left; if a negative number is passed, no previous Room is left.
 * @param [asSpectator = false] - <code>true</code> to join the Room as a spectator (in Game Rooms only).
 */
declare class JoinRoomRequest {
 ...
 * @param [message = null] - A custom message to be delivered to the user before kicking him; if <code>null</code>, the default message configured in the SmartFoxServer 2X Administration Tool is used.
 * @param [delaySeconds = 5] - The number of seconds after which the user is kicked after receiving the kick message.
 */
declare class KickUserRequest {
 ...
 * 	console.log("User " + user.name + " just left Room " + room.name);
 * }
 * @param [room = null] - The <em>SFSRoom</em> object corresponding to the Room that the current user must leave. If <code>null</code>, the last Room joined by the user is left.
 */
declare class LeaveRoomRequest {
 ...
 * @param [password = null] - The user password to access the system. SmartFoxServer doesn't offer a default authentication system, so the password must be validated implementing a custom login system in the Zone's server-side Extension.
 * @param [params = null] - An instance of <em>SFSObject</em> containing custom parameters to be passed to the Zone Extension (requires the custom login system to be active).
 * @param [zoneName = null] - The name (case-sensitive) of the server Zone to login to; if a Zone name is not specified, the client will use the setting passed to the <em>SmartFox</em> class constructor.
 */
 ...
 * 	avatar.y = dataObj.get("y");
 * }
 * @param object - A <em>SFSObject</em> containing custom parameters to be sent to the message recipients.
 * @param [targetRoom = null] - The <em>SFSRoom</em> object corresponding to the Room where the message should be dispatched; if <code>null</code>, the last Room joined by the user is used.
 * @param [recipients = null] - A list of <em>SFSUser</em> objects corresponding to the message recipients; if <code>null</code>, the message is sent to all users in the target Room (except the sender himself).
 */
declare class ObjectMessageRequest {
 ...
 * @param [params = null] - A <em>SFSObject</em> containing additional custom parameters to be sent to the message recipients (for example the color of the text, etc).
 * @param [targetRoom = null] - The <em>SFSRoom</em> object corresponding to the Room where the message should be dispatched; if <code>null</code>, the last Room joined by the user is used.
 */
declare class PublicMessageRequest {
 ...
 * @param [params = null] - A <em>SFSObject</em> containing additional custom parameters to be sent to the message recipient (for example the color of the text, etc).
 */
declare class PrivateMessageRequest {
 ...
 * @param [params = null] - A <em>SFSObject</em> containing custom parameters to be sent to the recipient user/s.
 */
declare class ModeratorMessageRequest {
 ...
 * @param recipientMode - An instance of <em>MessageRecipientMode</em> containing the target to which the message should be delivered.
 * @param [params = null] - An <em>SFSObject</em> containing custom parameters to be sent to the recipient user/s.
 */
declare class AdminMessageRequest {
    constructor(message: string, recipientMode: MessageRecipientMode, params?: SFSObject);
}
 ...
 * 	console.log("Unable to become a spectator due to the following error: " + evtParams.errorMessage);
 * }
 * @param [targetRoom = null] - The <em>SFSRoom</em> object corresponding to the Room in which the player should be turned to spectator. If <code>null</code>, the last Room joined by the user is used.
 */
declare class PlayerToSpectatorRequest {
 ...
 * @example
 * <caption>This example makes the current user quickly join a Darts game with a "maximum bet" condition.</caption>
 * function someMethod()
 * {
 ...
 * 	console.log("Successfully joined Room: " + evtParams.room);
 * }
 * @param matchExpression - A matching expression that the system will use to search a Room where to join the current user.
 * @param groupList - An array of Group names to which the matching expression should be applied.
 * @param settings - An object containing the Room configuration settings.
 * @param [roomToLeave = null] - A <em>SFSRoom</em> object representing the Room that the user should leave when joining the game.
 */
declare class QuickJoinOrCreateRoomRequest {
 ...
 * 	}
 * }
 * @param roomVariables - A list of <em>SFSRoomVariable</em> objects representing the Room Variables to be set.
 * @param [room = null] - A <em>SFSRoom</em> object representing the Room where to set the Room Variables; if <code>null</code>, the last Room joined by the current user is used.
 */
declare class SetRoomVariablesRequest {
 ...
 * 	}
 * }
 * @param userVariables - A list of <em>SFSUserVariable</em> objects representing the User Variables to be set.
 */
declare class SetUserVariablesRequest {
 ...
 * 	console.log("Unable to become a player due to the following error: " + evtParams.errorMessage);
 * }
 * @param [targetRoom = null] - The <em>SFSRoom</em> object corresponding to the Room in which the spectator should be turned to player. If <code>null</code>, the last Room joined by the user is used.
 */
declare class SpectatorToPlayerRequest {
    constructor(targetRoom?: SFSRoom);
}
 ...
 */
declare class SubscribeRoomGroupRequest {
 ...
 */
declare class UnsubscribeRoomGroupRequest {
    constructor(groupId: string);
}
 ...
 */
declare class Logger extends EventDispatcher {
    /**
 ...
 */
declare class ClientDisconnectionReason {
    constructor();
    /**
